...
>(num: number, bindTo: any, last: F): ReturnType<F>[]
export function doIt<
  F extends (...params: any[]) => any = (...params: any[]) => any
>(bindTo: any, num: number, last: F): ReturnType<F>[]
export function doIt<
  F extends (...params: any[]) => any = (...params: any[]) => any
>(bindTo: any, last: F, num: number): ReturnType<F>[]
export function doIt<
  F extends (...params: any[]) => any = (...params: any[]) => any
>(num: number, last: F): ReturnType<F>[]
export function doIt<
  F extends (...params: any[]) => any = (...params: any[]) => any
>(last: F, num: number): ReturnType<F>[]
export function doIt<
  F extends (...params: any[]) => any = (...params: any[]) => any
